...
const ACTION_SPECS = [
  ...
  { id: "detail.annotation.select", surface: "detail", modes: ["preview"], label: "select text", description: "Select an exact rendered range for a durable comment", defaultChords: ["v"], helpPriority: 94, menuGroup: "Edit" },
