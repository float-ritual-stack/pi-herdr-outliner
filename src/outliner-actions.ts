...
const ACTION_SPECS = [
  ...
  { id: "tree.cancel", surface: "tree", modes: ["delete", "viewer", "edit", "add-child", "add-sibling", "capture", "filter", "goto", "purge", "action-menu"], label: "cancel", description: "Cancel the current transient mode", defaultChords: ["Esc"], helpPriority: 100, menuGroup: "System" },
  ...
  { id: "tree.detail.new", surface: "tree", modes: ["browse"], label: "Detail below", description: "Open a new independent Detail below this pane", defaultChords: ["Shift+D"], helpPriority: 85, menuGroup: "Pane" },
  { id: "tree.detail.right", surface: "tree", modes: ["browse"], label: "Detail right", description: "Open a new independent Detail to the right", defaultChords: [], helpPriority: 84, menuGroup: "Pane" },
  ...
  { id: "tree.delete", surface: "tree", modes: ["browse"], label: "Trash", description: "Enter confirm-before-Trash mode", defaultChords: ["d"], helpPriority: 35, menuGroup: "Edit" },
  ...
  { id: "tree.input.save", surface: "tree", modes: ["edit", "add-child", "add-sibling", "capture", "filter", "goto", "purge"], label: "save", description: "Commit the current transient input", defaultChords: ["Enter"], helpPriority: 95, menuGroup: "Edit" },
  ...
  { id: "tree.input.move.up", surface: "tree", modes: ["edit", "add-child", "add-sibling", "capture", "filter", "goto"], label: "previous", description: "Move to the previous line or completion", defaultChords: ["ArrowUp"], helpPriority: 70, menuGroup: "Navigate" },
  { id: "tree.input.move.down", surface: "tree", modes: ["edit", "add-child", "add-sibling", "capture", "filter", "goto"], label: "next", description: "Move to the next line or completion", defaultChords: ["ArrowDown"], helpPriority: 70, menuGroup: "Navigate" },
  { id: "tree.input.multiline", surface: "tree", modes: ["edit", "add-child", "add-sibling", "capture"], label: "multiline", description: "Continue this edit in multiline form", defaultChords: ["Ctrl+E", "Shift+Enter"], helpPriority: 75, menuGroup: "Edit" },
  ...
  { id: "detail.menu.open", surface: "detail", modes: ["preview", "annotation", "file"], label: "actions", description: "Open contextual actions and effective bindings", defaultChords: ["?"], helpPriority: 25, menuGroup: "System" },
  { id: "detail.keymap.reload", surface: "detail", modes: ["preview", "annotation", "file"], label: "reload keys", description: "Atomically reload the Outliner keymap", defaultChords: ["Ctrl+R"], helpPriority: 5, menuGroup: "System" },
  ...
  { id: "detail.lock.toggle", surface: "detail", modes: ["preview", "annotation", "file"], label: "lock", description: "Lock or unlock this Detail target", defaultChords: ["Shift+L", "i", "Ctrl+L"], helpPriority: 70, menuGroup: "Pane" },
  ...
  { id: "detail.pane.right", surface: "detail", modes: ["preview", "annotation", "file"], label: "Detail right", description: "Open this target in a new Detail to the right", defaultChords: [], helpPriority: 44, menuGroup: "Pane" },
  { id: "detail.pane.below", surface: "detail", modes: ["preview", "annotation", "file"], label: "Detail below", description: "Open this target in a new Detail below", defaultChords: [], helpPriority: 43, menuGroup: "Pane" },
