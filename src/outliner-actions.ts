...
const ACTION_SPECS = [
  ...
  { id: "detail.pane.right", surface: "detail", modes: ["preview", "annotation", "file", "property"], label: "Detail right", description: "Open this target in a new Detail to the right", defaultChords: ["Alt+Shift+ArrowRight"], helpPriority: 44, menuGroup: "Pane" },
  { id: "detail.pane.below", surface: "detail", modes: ["preview", "annotation", "file", "property"], label: "Detail below", description: "Open this target in a new Detail below", defaultChords: ["Alt+Shift+ArrowDown"], helpPriority: 43, menuGroup: "Pane" },
