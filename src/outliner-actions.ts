...
const ACTION_SPECS = [
  ...
  { id: "tree.bookmark.toggle", surface: "tree", modes: ["browse"], label: "bookmark", description: "Add or remove a bookmark for the selected block", defaultChords: ["Alt+M"], helpPriority: 72, menuGroup: "Edit" },
  { id: "tree.bookmarks.open", surface: "tree", modes: ["browse"], label: "bookmarks", description: "Open the Bookmarks split navigator", defaultChords: ["Alt+Shift+M"], helpPriority: 71, menuGroup: "Navigate" },
  ...
  { id: "detail.bookmark.toggle", surface: "detail", modes: ["preview", "annotation", "file", "property"], label: "bookmark", description: "Add or remove a bookmark for this block", defaultChords: ["Alt+M"], helpPriority: 76, menuGroup: "Edit" },
  { id: "detail.bookmarks.open", surface: "detail", modes: ["preview", "annotation", "file", "property"], label: "bookmarks", description: "Open the Bookmarks split navigator", defaultChords: ["Alt+Shift+M"], helpPriority: 75, menuGroup: "Navigate" },
  ...
  { id: "detail.annotation.select", surface: "detail", modes: ["preview"], label: "source comment", description: "Select an exact authored source range for a source-linked comment", defaultChords: ["v"], helpPriority: 94, menuGroup: "Edit" },
  ...
  { id: "detail.annotation.reveal", surface: "detail", modes: ["annotation"], label: "reveal annotation", description: "Open the annotation source with its exact range selected", defaultChords: ["r"], helpPriority: 93, menuGroup: "Navigate" },
  ...
  { id: "detail.comment.begin", surface: "detail", modes: ["file", "select"], label: "comment", description: "Open a contextual buffer on the selected rendered or file range", defaultChords: ["c"], helpPriority: 51, menuGroup: "Edit" },
