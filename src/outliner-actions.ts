...
const ACTION_SPECS = [
  ...
  { id: "detail.reference.reveal", surface: "detail", modes: ["preview", "annotation", "file"], label: "reveal link", description: "Reveal the focused or first reference in Tree", defaultChords: ["Alt+Shift+R"], helpPriority: 79, menuGroup: "Navigate" },
