...
const ACTION_SPECS = [
  ...
  { id: "detail.resource.refresh", surface: "detail", modes: ["preview"], label: "refresh web resource", description: "Conditionally refresh the current cached web representation", defaultChords: ["r"], helpPriority: 93, menuGroup: "View" },
