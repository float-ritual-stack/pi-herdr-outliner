...
const ACTION_SPECS = [
  ...
  { id: "detail.cancel", surface: "detail", modes: ["edit", "select", "comment"], label: "cancel", description: "Cancel the current editor or source selection without saving", defaultChords: ["Esc"], helpPriority: 100, menuGroup: "System" },
  ...
  { id: "detail.annotation.select", surface: "detail", modes: ["preview"], label: "select text", description: "Select an exact source range for a durable comment", defaultChords: ["v"], helpPriority: 94, menuGroup: "Edit" },
  ...
  { id: "detail.comment.begin", surface: "detail", modes: ["file", "select"], label: "comment", description: "Comment on the selected source or file range", defaultChords: ["c"], helpPriority: 51, menuGroup: "Edit" },
